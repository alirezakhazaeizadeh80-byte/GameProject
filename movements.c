    ...
    for (int i = 0; i < huntersCount; i++){
        ...
        if (hy > 1 && hy - py > 1 && isWall[hx][hy - 1][1] == 0 && isWall[hx][hy - 2][1] == 0 && isHunter[hx][hy - 2] == 0) { 
            ...
            if(hx > 0 && hx - px > 0 && isWall[hx - 1][hy - 1][0] == 0 && isHunter[hx - 1][hy - 1] == 0){
                isHunter[hx][hy - 1] = 0; isHunter[hx - 1][hy - 1] = 1;
                hunters[i][0] -= 1;
                moved = 2;
                dir[i]=0;
            }
        ...
        if(moved != 2){ // check for a better movement
            if(hx > 1 && hx - px > 1 && isWall[hx - 1][hy][0] == 0 && isWall[hx - 2][hy][0] == 0 && isHunter[hx - 2][hy] == 0){
                ...
                if(hy < m - 1 && hy - py < 0 && isWall[hx + 1][hy][1] == 0 && isHunter[hx + 1][hy + 1] == 0){
                    if(moved == 1){ // ignore previous horizental movement
                        isHunter[hunters[i][0]][hunters[i][1]] = 0;
                        hunters[i][0] = hx;
                        hunters[i][1] = hy;
                    }
            ...
            if(*alivePlayers == 1){
                ...
                *GameStoppage=1;
                ...
                if(fabs(oldHunters[ind][0] - hunters[ind][0]) <= 0.02 && fabs(oldHunters[ind][1] - hunters[ind][1]) <= 0.02){
                    if(*counter != 0 && playerMoved[i] == 1)(*counter) -= 1; // for board quake bonus
     ...
     if(GameStoppage == 0){
            ...
            if((*player) != -1 && playerMoved[*player] == 0){
                if (IsKeyPressed(KEY_W))
                {
                    ...
                    if(*showError == 0){playerMoved[*player] = 1; if(*MovePlayerBonus != -1) *MovePlayerBonus = -1;}
                }
            ...
            if((*timer) != -1 && *MovePlayerBonus == -1)(*timer) += GetFrameTime();
            if((*timer) >= 0.4 && (*option) != 2 && *MovePlayerBonus == -1){ // related to board quake bonus
